...
#include "common/hardware/config_wire.h"
#include "common/hardware/messages.h"
#include "common/protocol/udp.h"
...
struct SubsystemTracker {
  ...
  bool timed_out{true};
  std::unique_ptr<ipc::Subscriber<talos::drive::Packet>> subscriber;
  std::unique_ptr<ipc::Subscriber<talos::drive::Packet>> alt_subscriber;
};
