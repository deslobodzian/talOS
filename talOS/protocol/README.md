...
The RoboRIO program now runs the hardware gateway in `talOS/hardware`.
...
`2026-robot/main_processor/drivetrain/README.md`. For an automated loopback test without WPILib,
