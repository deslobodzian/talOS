...
TEST(HardwareNodeTest, MergesSubsystemRequestsAndIsolatesTimeouts) {
  ...
  ipc::Publisher<talos::hardware::Packet> drive_pub{"/hw/req/drivetrain"};
  ipc::Publisher<talos::hardware::Packet> shooter_pub{"/hw/req/shooter"};
  ...
  ipc::Publisher<talos::hardware::Packet> hw_state_pub{"/hw/state"};
...
TEST(HardwareNodeTest, ForwardsDriverStationPacketsToIpc) {
  ...
  ipc::Subscriber<talos::hardware::Packet> ds_sub{"/hw/ds"};
