...
enum class MemorySource { Allocate, External };
...
class Allocator {
 public:
  ...
  virtual void copy_out(const Allocation& src, void* dst,
                        std::size_t bytes) = 0;
  virtual void copy_between(Allocation& dst, const Allocation& src,
                            std::size_t bytes) = 0;
};
